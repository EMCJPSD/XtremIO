...
def sendRequest(c_name):
	...
	String64=base64.encodestring(strAuth).replace('\n', '')
	#req.add_header("Authorization","Basic "+base64.encodestring(strAuth))
	req.add_header("Authorization","Basic "+String64)
	#resp=urllib2.urlopen(req)
	#gcontext=ssl.CERT_NONE
	#req.get('https://10.32.3.109/api/json/types/xenvs', verify=False)
...
def get_performance(c_name):
	...
	url="https://10.32.3.109/api/json/types/"+c_name
